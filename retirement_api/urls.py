...
urlpatterns = [
    ...
    re_path(r'^before-you-claim/about/es/$', about, {'language': 'es'},
            name='about_es'),
    re_path(r'^before-you-claim/$', claiming, name='claiming'),
    re_path(r'^before-you-claim/es/$', claiming, {'es': True},
            name='claiming_es'),
    re_path(r'^retirement-api/estimator/(?P<dob>[^/]+)/(?P<income>\d+)/$',
            estimator, name='estimator'),
    re_path(r'^retirement-api/estimator/(?P<dob>[^/]+)/(?P<income>\d+)/es/$',
