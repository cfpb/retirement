...
class Question(models.Model):
    ...
    answer_yes_a = models.TextField(max_length=255, blank=True, help_text="Under 50")
    answer_yes_b = models.TextField(max_length=255, blank=True, help_text="50 and older")
    answer_no_a = models.TextField(max_length=255, blank=True, help_text="Under 50")
    answer_no_b = models.TextField(max_length=255, blank=True, help_text="50 and older")
    answer_unsure_a = models.TextField(max_length=255, blank=True, help_text="Under 50")
    answer_unsure_b = models.TextField(max_length=255, blank=True, help_text="50 and older")
